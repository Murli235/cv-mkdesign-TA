    ...
    <div class="list-project mt-5">
        <div class="container-fluid">
            <div class="row px-1 px-md-5 py-3 py-md-5">
                <div class="col-md-12">
                    <form method="post" action="{{ route('detailSurveiUpdate.index', $survei) }}"
                        ...
                        <div class="card p-2" style="border: none">
                            ...
                            <div class="card-body">
                                ...
                                <p class="d-flex justify-content-between ">
                                    Tanggal
                                    <span>{{ $survei->surveiDate }}</span>
                                </p>
                                <p class="d-flex justify-content-between ">
                                    Waktu
                                    <span>{{ $survei->surveiTime }}</span>
                                </p>
                                <p class="d-flex justify-content-between">
                                    Biaya Transport
                                    <span>Rp {{ number_format($survei->cost) }}</span>
                                </p>
                                <p class="d-flex justify-content-between">
                                    Design Type
                                    <span>{{ $survei->designType }}</span>
                                </p>
                                <hr>
                                ...
                                <div class="mt-3 text-end">
                                    <div class="mb-3">
                                        ...
                                        <span>0233974444</span>
                                    </div>
                                    @if ($survei->status == 'Unpaid' && $survei->cost != 0)
                                    ...
                                    @else
                                        ...
                                        <a class="btn
                                            ...
                                            href="{{ asset('img/payment/survei/' . $survei->paymentReceipt) }}">
                                            {{ $survei->status }}
                                        </a>
                                    @endif
                                </div>
