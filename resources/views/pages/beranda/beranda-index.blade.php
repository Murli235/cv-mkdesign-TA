        ...
        <div class="container-fluid">
            <div class="row px-1 px-md-5 py-3 py-md-5">
                <div class="col-md-6 left-side lh-1">
                    <h2 class="lh-1">CV. MEGA KREASI <span>DESIGN</span></h2>
                    <h6 class="lh-1 fw-normal">Design And Build Interior & Eksterior</h6>
                    <h6 class="lh-1 fw-bold">Bandar Lampung</h6>
                    <h6 class="lh-1 fw-bold">Since 2018</h6>
                </div>
        ...
        <div class="container-fluid">
            <div class="row px-1 px-md-5 py-3 py-md-5">
                    ...
                    <div class="col-12 mb-5">
                        <div class="card">
                            <div class="card-body p-4">
                                <div class="row p-0">
                                    @foreach ($project->Galery->take(8) as $galery)
                                        <div class="col-md-3 p-1" data-aos="zoom-in" data-aos-duration="700">
                ...
                <div class="text-center">
                    <a href="{{ route('ourProject.index') }}" class="btn btn-md btn-outline-dark m-auto">Lihat Semua
                        Project</a>
                </div>
            </div>
        </div>
